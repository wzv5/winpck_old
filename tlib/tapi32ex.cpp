...
BOOL (WINAPI *pCryptSignHash)(HCRYPTHASH, DWORD, LPCTSTR, DWORD, BYTE *, DWORD *);//////
...
BOOL (WINAPI *pCryptVerifySignature)(HCRYPTHASH, CONST BYTE *, DWORD, HCRYPTKEY, LPCTSTR, DWORD);/////
...
{
	HMODULE	advdll = ::GetModuleHandleA("advapi32.dll");

#ifdef UNICODE
	pCryptAcquireContext = (BOOL (WINAPI *)(HCRYPTPROV *, LPCWSTR, LPCWSTR, DWORD, DWORD))
		::GetProcAddress(advdll, "CryptAcquireContextW");
#else
...
#ifdef UNICODE
	pCryptSignHash = (BOOL (WINAPI *)(HCRYPTHASH, DWORD, LPCWSTR, DWORD, BYTE *, DWORD *))
		::GetProcAddress(advdll, "CryptSignHashW");
	pCryptVerifySignature =
		(BOOL (WINAPI *)(HCRYPTHASH, CONST BYTE *, DWORD, HCRYPTKEY, LPCWSTR, DWORD))
		::GetProcAddress(advdll, "CryptVerifySignatureW");
#else
...
//{
//	HINSTANCE	cryptdll = ::LoadLibraryA("crypt32.dll");
//
//	pCryptProtectData =
